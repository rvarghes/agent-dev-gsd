...
- Usage: Reference from command with `@/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
