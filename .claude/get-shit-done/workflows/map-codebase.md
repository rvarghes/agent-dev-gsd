...
```bash
INIT=$(node "/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
