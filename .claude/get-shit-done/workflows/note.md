...
- **Global scope**: `/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/notes/`)
...
2. Glob `/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rogy.varghese/workspace/claude/software-development-gsd/.claude/notes/` — works in any directory
